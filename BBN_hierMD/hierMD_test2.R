...
# The more complicated mixture model gives CPT results less shrunken towards the
# marginal distribution of the child node than does the Azzimonti-Corani model.
# In resulting inferences, both are an improvement over a flat prior -- "BDeu" 
# (Laplace smoothing).
#
...
# The movie nodes have states that are in half-point deviations from a viewer's
...
querygrain(bbn,nodes = c("Has_Seen","age"),type="conditional")
querygrain(
  bbn,
